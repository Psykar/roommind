...
async def test_mpc_apply_eco_sets_supported_child_preset():
    """Automatic eco mode pushes an eco preset to preset-capable child climates."""
...
@pytest.mark.asyncio
async def test_mpc_apply_no_preset_when_device_lacks_support():
    """Devices without preset_modes never receive a set_preset_mode call."""
    _last_commands.clear()
    hass = build_hass()
    state = MagicMock()
    state.state = "heat"
